            ...
            <ul class="nav-main">
                ...
                <li class="nav-main-item">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link @if(Request::segment(2) == '/add-translations') active @endif" href="{{ route('translations.create') }}">
                                <span class="nav-main-link-name">Əlavə et</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link @if(Request::segment(2) == "translations") active @endif" href="{{ route('listTranslations') }}">
